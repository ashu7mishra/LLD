...
class Counter:
    def __init__(self, initial_count):
        ...
        self._lock = threading_process.Lock()
...
threads = []
for _ in range(10):
    thread_inc = threading_process.Thread(target=concurrent_inc, args=(counter, 1))
    thread_dec = threading_process.Thread(target=concurrent_dec, args=(counter, 1))
